      ...
      const top10locations = enriched.map((el) => {
        ...
        for (const prev of previousData) {
          if (el._id?.toLowerCase() === prev._id?.toLowerCase()) {
            percentCompare = prev.count > 0 ? (el.count * 100) / prev.count - 100 : 100;
...
export function enrichWithCoordinates(data: LocationRawItem[]): LocationRawItem[] {
...
export const PROVINCE_LIST: ProvinceInfo[] = [
  ...
  { th: 'กำแพงเพชร', en: 'Kamphaeng Phet', ll: [16.4827798, 99.52266179999992] },
  { th: 'ขอนแก่น', en: 'Khon Kaen', ll: [16.4419355, 102.8359921] },
  { th: 'จันทบุรี', en: 'Chanthaburi', ll: [12.61134, 102.10385459999998] },
  { th: 'ฉะเชิงเทรา', en: 'Chachoengsao', ll: [13.6904194, 101.07795959999999] },
  ...
  { th: 'นครราชสีมา', en: 'Nakhon Ratchasima', ll: [14.9798997, 102.09776929999998] },
  { th: 'นครศรีธรรมราช', en: 'Nakhon Si Thammarat', ll: [8.4303975, 99.96312190000003] },
  ...
  { th: 'ประจวบคีรีขันธ์', en: 'Prachuap Khiri Khan', ll: [11.812367, 99.79732709999996] },
  { th: 'ปทุมธานี', en: 'Pathum Thani', ll: [14.0208391, 100.52502759999993] },
  { th: 'ปราจีนบุรี', en: 'Prachin Buri', ll: [14.0509704, 101.37274389999993] },
  { th: 'ปัตตานี', en: 'Pattani', ll: [6.869484399999999, 101.25048259999994] },
  { th: 'พระนครศรีอยุธยา', en: 'Phra Nakhon Si Ayutthaya', ll: [14.3532128, 100.56895989999998] },
  ...
  { th: 'มหาสารคาม', en: 'Maha Sarakham', ll: [16.1850896, 103.30264609999995] },
  ...
  { th: 'สมุทรปราการ', en: 'Samut Prakan', ll: [13.5990961, 100.59983190000003] },
  { th: 'สมุทรสงคราม', en: 'Samut Songkhram', ll: [13.4098217, 100.00226450000002] },
  ...
  { th: 'หนองบัวลำภู', en: 'Nong Bua Lamphu', ll: [17.2218247, 102.42603680000002] },
  ...
  { th: 'อุบลราชธานี', en: 'Ubon Ratchathani', ll: [15.2286861, 104.85642170000006] },
  { th: 'อำนาจเจริญ', en: 'Amnat Charoen', ll: [15.8656783, 104.62577740000006] },
];
